/* [ ---- Frimouss Admin Panel - mailbox ---- ] */

    $(document).ready(function() {
		//* make row clickable
		frimouss_mailbox.msg_rowLink();
       
	    //* new message
        frimouss_mailbox.new_message();
		//* inbox
        frimouss_mailbox.inbox();
		//* outbox
        frimouss_mailbox.outbox();
        //* outbox
        frimouss_mailbox.trash();
		
		//* defaults actions: selecting rows, stars
		frimouss_mailbox.actions();
    });
